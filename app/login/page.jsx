...
import style from '../assets/imagw23.png'
        ...
        <div className="min-h-screen flex flex-col items-center justify-center">
          <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
              ...
              <form>
               ...
               Already have an account?
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                  ...
                  <div>
                    <a href="javascript:void(0);" className="text-sky-500 font-semibold text-sm hover:underline">
                      Forgot Password?
                    </a>
                  </div>
                </div>
            ...
            <div className="rounded-xl lg:p-8 p-8">
              <Image src={style} width={500} height={500} className="md:w-[60%] md:h-[50%] object-cover mx-auto" alt="login-image" />
            </div>
          </div>
        </div>
      </div>
